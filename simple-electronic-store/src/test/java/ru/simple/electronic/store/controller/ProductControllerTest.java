...
class ProductControllerTest {
    ...
    void getProductsTest() throws Exception {
        ...
        when(productOrderService.findCurrentOrderOrCreateNew(any())).thenReturn(Mono.just(new ProductOrderDto()));
    ...
    void getProductByIdTest() throws Exception {
        ...
        when(productOrderService.findCurrentOrderOrCreateNew(any())).thenReturn(Mono.just(productOrderDto));
